...
;(function($) {
  $.fn.customselect = function(method, value) {
    ...
    var $options  = {
      ...
      // return navigator.platform && /(android|iPhone|ipad|blackberry)/i.test(navigator.userAgent);
	  return /Mobi/.test(navigator.userAgent);
	  //return navigator.platform && navigator.userAgent.match(/(android|<a href="http://www.jqueryscript.net/tags.php?/iphone/">iphone</a>|ipad|blackberry)/i);
      }
    };
